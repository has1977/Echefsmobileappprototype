  ...
  const menuItems: Omit<MenuItem, 'id' | 'rating' | 'reviewCount'>[] = [
    ...
    // ========================================
    {
      ...
      modifiers: [
        {
          id: 'mod_protein',
          translations: { en: 'Add Protein', ar: 'إضافة بروتين', ru: 'Добавить белок', ky: 'Белок кошуу' },
          type: 'add',
          required: false,
          options: [
            { id: 'opt_chicken', translations: { en: 'Grilled Chicken', ar: 'دجاج مشوي', ru: 'Курица гриль', ky: 'Грильде тоок' }, price: 5.99 },
            { id: 'opt_shrimp', translations: { en: 'Grilled Shrimp', ar: 'جمبري مشوي', ru: 'Креветки гриль', ky: 'Грильде креветка' }, price: 7.99 },
            { id: 'opt_salmon', translations: { en: 'Grilled Salmon', ar: 'سلمون مشوي', ru: 'Лосось гриль', ky: 'Грильде лосось' }, price: 8.99 },
          ],
        },
      ],
      enabled: true,
